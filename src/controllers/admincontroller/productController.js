...
const product = async (req, res) => {
  ...
  try {
    ...
    console.log(
      "error while loading the product listing page fron the admin side",
      error
    );
...
const addProductPost = async (req, res) => {
  try {
    ...
    const product = new productModel({
      ...
      totalstock:
        parseInt(req.body.s1) +
        parseInt(req.body.s2) +
        parseInt(req.body.s3) +
        parseInt(req.body.s4) +
        parseInt(req.body.s5),
...
const updateProduct = async (req, res) => {
  try {
    ...
    console.log(
      "error occured while rendering the product updating page",
      error
    );
    res.render("admin/servererror");
  }
...
const updateImage = async (req, res) => {
  try {
    ...
    console.log(
      "error occured while editing the image from the admin side",
      error
    );
    res.render("admin/servererror");
  }
...
const updateImagePost = async (req, res) => {
  try {
    ...
    console.log(
      "error occured while updating the image from the admin side",
      error
    );
    res.render("admin/servererror");
  }
